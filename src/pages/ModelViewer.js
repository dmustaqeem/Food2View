...
const card = (
 ...
 return (
  <main>
    ...
    <CanvasSt ><Three status="none" model={selectedModel}/></CanvasSt>
    <article>
    ...
    <Button variant="contained" onClick={() => handleToggle()}>  View Model  <FullscreenIcon size="xl"></FullscreenIcon></Button>
    </div>
    
    <div className="productButtonDiv">
       <Button variant="contained">  Try in AR  <ViewInArIcon></ViewInArIcon></Button>
    </div>
